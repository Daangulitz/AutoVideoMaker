...
def make_image_card(image_url, title, output_path="output.png"):
    try:
        # Load and crop image with headers to avoid 403 errors
        headers = {
        ...
        # Resize to 1080x1080 if smaller
        if img.size[0] < 1080:
        ...
        overlay_draw.rectangle(
            ...
            fill=(0, 0, 0, 140)  # Slightly dark background for readability
        )
        ...
        raise e  # Re-raise to handle in main script if needed
